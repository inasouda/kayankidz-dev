...
import ramadanImg from "../assets/imgs/ramadan6.webp";
import hajjImg from "../assets/imgs/hajj3.webp";
...
const Events = () => {
  const ramadanEventImages = [
    ...
    ramadan6, ramadan8, ramadan9, ramadan10,
    ramadan11, ramadan12, ramadan13, ramadan14

  ];
  const hajjEventImages = [
    hajj1, hajj2, hajj4, hajj5, hajj6, hajj7, hajj8
  ...
  return (
      ...
      <VStack id='events'  spacing={8} p={4} >
        ...
        <Event
          ...
          bgcolor="#008080"
          headerImg = {ramadanEvent.headerImg}
        />
        <Event
